...
```bash
python -m segmentacion_oraciones.src.plan_sintetico --shuffle --seed 13 --max 80 --output segmentacion_oraciones/outputs/synthetic_plan/lote_001.jsonl
```

Para generar la grilla completa:

```bash
python -m segmentacion_oraciones.src.plan_sintetico --output segmentacion_oraciones/outputs/synthetic_plan/full_5040.jsonl
```
