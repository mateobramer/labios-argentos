"""Simulador offline del flujo segmentacion_oraciones sin GPU ni servicios externos."""
...
from segmentacion_oraciones.src.contracts import CommitAction, FeedbackEvent, PartialHypothesis
from segmentacion_oraciones.src.feedback import FeedbackWriter
from segmentacion_oraciones.src.logging_utils import JSONLLogger, provider_log_event
from segmentacion_oraciones.src.provider_factory import make_closure_provider, make_correction_provider
from segmentacion_oraciones.src.validation import validate_commit_decision, validate_correction_result
...
def run_simulation(
    ...
    *,
    ...
    timeout_s: float = 2.5,
    log_path: str | Path = "segmentacion_oraciones/outputs/llm_logs/events.jsonl",
    feedback_path: str | Path = "segmentacion_oraciones/outputs/feedback/events.jsonl",
) -> dict[str, object]:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Simula el flujo segmentacion_oraciones sin GPU ni LLM externo.")
    ...
    parser.add_argument("--log-path", default="segmentacion_oraciones/outputs/llm_logs/events.jsonl")
    parser.add_argument("--feedback-path", default="segmentacion_oraciones/outputs/feedback/events.jsonl")
