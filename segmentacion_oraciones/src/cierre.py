"""Cierre de oracion conservador para el MVP segmentacion_oraciones."""
...
from segmentacion_oraciones.src.validation import fallback_commit, validate_commit_decision
