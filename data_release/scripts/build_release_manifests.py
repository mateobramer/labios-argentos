...
SHORTLIST = ROOT / "data_discovery" / "outputs" / "shortlist_recommended.csv"
CANDIDATE_SCORES = ROOT / "data_discovery" / "outputs" / "candidate_scores.csv"
TARGET_PROGRESS = ROOT / "data_discovery" / "outputs" / "target_progress.md"
BUCKET_INVENTORY = ROOT / "data_inventory" / "bucket_inventory.csv"
        ...
        rows.append(
            {
                ...
                "notes": "accepted_only_from_data_discovery",
            }
        )
