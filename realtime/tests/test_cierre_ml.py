...
from realtime.src.entrenar_cierre import run_training_pipeline
from realtime.src.plan_sintetico import build_variations
...
class TestCierreML(unittest.TestCase):
    ...
    def test_pipeline_completo_escribe_summary(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            splits = split_examples(load_training_examples(["realtime/examples/ground_truth_demo.json"]), seed=11)
