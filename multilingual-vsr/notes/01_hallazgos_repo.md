...
2. [sin GPU] Setup: clonar repo en multilingual-vsr/, env de requirements.txt, bajar modelo ES + LM.
...
(lower, sin acentos, ñ ok). Harness: multilingual-vsr/scripts/zeroshot.py. ~12s/clip en CPU.
