...
from cleaning.transcript_segmentation.src.llm_training import export_sft_jsonl
...
class TestLLMTrainingExport(unittest.TestCase):
    def test_export_sft_jsonl(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            export_sft_jsonl(["cleaning/transcript_segmentation/examples/ground_truth_demo.json"], output)
