...
from cleaning.transcript_segmentation.src.secuencias import (
...
class TestSecuencias(unittest.TestCase):
    def test_load_ground_truth_demo_and_evaluate(self):
        sequence = load_sequence_ground_truth("cleaning/transcript_segmentation/examples/ground_truth_demo.json")
