...
from cleaning.transcript_segmentation.src.cierre_ml import (
...
from cleaning.transcript_segmentation.src.entrenar_cierre import run_training_pipeline
from cleaning.transcript_segmentation.src.plan_sintetico import build_variations
from cleaning.transcript_segmentation.src.provider_factory import make_closure_provider


class TestCierreML(unittest.TestCase):
    def test_carga_ground_truth_secuencial(self):
        examples = load_training_examples(["cleaning/transcript_segmentation/examples/ground_truth_demo.json"])
    ...
    def test_pipeline_completo_escribe_summary(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            splits = split_examples(load_training_examples(["cleaning/transcript_segmentation/examples/ground_truth_demo.json"]), seed=11)
