...
```bash
python -m cleaning.transcript_segmentation.src.plan_sintetico --shuffle --seed 13 --max 80 --output cleaning/transcript_segmentation/outputs/synthetic_plan/lote_001.jsonl
```

Para generar la grilla completa:

```bash
python -m cleaning.transcript_segmentation.src.plan_sintetico --output cleaning/transcript_segmentation/outputs/synthetic_plan/full_5040.jsonl
```
