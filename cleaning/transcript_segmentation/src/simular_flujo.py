"""Simulador offline del flujo cleaning/transcript_segmentation sin GPU ni servicios externos."""
...
from cleaning.transcript_segmentation.src.contracts import CommitAction, FeedbackEvent, PartialHypothesis
from cleaning.transcript_segmentation.src.feedback import FeedbackWriter
from cleaning.transcript_segmentation.src.logging_utils import JSONLLogger, provider_log_event
from cleaning.transcript_segmentation.src.provider_factory import make_closure_provider, make_correction_provider
from cleaning.transcript_segmentation.src.validation import validate_commit_decision, validate_correction_result
...
def run_simulation(
    ...
    *,
    ...
    timeout_s: float = 2.5,
    log_path: str | Path = "cleaning/transcript_segmentation/outputs/llm_logs/events.jsonl",
    feedback_path: str | Path = "cleaning/transcript_segmentation/outputs/feedback/events.jsonl",
) -> dict[str, object]:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Simula el flujo cleaning/transcript_segmentation sin GPU ni LLM externo.")
    ...
    parser.add_argument("--log-path", default="cleaning/transcript_segmentation/outputs/llm_logs/events.jsonl")
    parser.add_argument("--feedback-path", default="cleaning/transcript_segmentation/outputs/feedback/events.jsonl")
