...
DEFAULT_INPUTS = ["cleaning/transcript_segmentation/ground_truth"]
DEFAULT_AMOR_TEST = "cleaning/transcript_segmentation/ground_truth/charla_amor_desamor.json"
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="cleaning/transcript_segmentation/outputs/cierre_training")
