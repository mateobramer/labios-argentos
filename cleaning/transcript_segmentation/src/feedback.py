...
from cleaning.transcript_segmentation.src.contracts import FeedbackEvent
...
class FeedbackWriter:
    ...
    def __init__(self, path: str | Path = "cleaning/transcript_segmentation/outputs/feedback/events.jsonl") -> None:
        self.path = Path(path)
