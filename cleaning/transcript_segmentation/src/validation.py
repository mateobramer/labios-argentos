"""Validacion estricta y fallbacks seguros para providers cleaning/transcript_segmentation."""
...
from cleaning.transcript_segmentation.src.contracts import CommitAction, CommitDecision, CorrectionResult
