"""Helpers visuales livianos para notebooks de cleaning/transcript_segmentation."""
...
from cleaning.transcript_segmentation.src.cierre_ml import load_training_examples
...
def default_training_inputs() -> list[str]:
    inputs = ["cleaning/transcript_segmentation/ground_truth"]
