"""Cierre de oracion conservador para el MVP cleaning/transcript_segmentation."""
...
from cleaning.transcript_segmentation.src.contracts import CommitAction, CommitDecision, PartialHypothesis
from cleaning.transcript_segmentation.src.validation import fallback_commit, validate_commit_decision
