...
Uso (desde la raiz del repo, con un entorno que tenga openai-whisper):
    python -m cleaning.visual_quality.src.auditar_alineacion                 # todas las fuentes
    python -m cleaning.visual_quality.src.auditar_alineacion "<titulo>"      # una fuente
    WHISPER_MODEL=large-v3 python -m cleaning.visual_quality.src.auditar_alineacion "<titulo>"
