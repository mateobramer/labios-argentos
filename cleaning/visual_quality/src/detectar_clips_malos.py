...
Uso desde la raiz del repo (con cv2 + numpy instalados):
    python -m cleaning.visual_quality.src.detectar_clips_malos                 # audita todo
    python -m cleaning.visual_quality.src.detectar_clips_malos "<titulo>"      # una fuente
    python -m cleaning.visual_quality.src.detectar_clips_malos --materializar  # copia los keep -> dataset/
