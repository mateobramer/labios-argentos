...
from cleaning.visual_quality.src.visual_quality_metrics import (
    VideoFrames,
    cargar_frames,
...
def main() -> None:
    ...
    if args.preview_dir:
        from cleaning.visual_quality.src.visual_quality_report import generar_previews_manifest

        generar_previews_manifest(rows, args.preview_dir)
    if args.keep_output:
        from cleaning.visual_quality.src.visual_quality_report import escribir_manifest_filtrado
