...
from cleaning.visual_quality.src.visual_quality_policy_analysis import (
    POLICY_COLUMNS,
    PolicyConfig,
...
class TestVisualQualityPolicyAnalysis(unittest.TestCase):
    ...
    def test_notebook_04_es_presentacion_corta(self):
        path = Path("cleaning/visual_quality/notebooks/04_auditoria_visual_offline.ipynb")
    ...
    def test_notebook_05_no_define_helpers_largos(self):
        path = Path("cleaning/visual_quality/notebooks/05_diagnostico_politicas_visuales.ipynb")
