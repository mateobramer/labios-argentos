...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=yJxDKBgw5NU"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=OrwtPwftIi4"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=qEKPgqURvo0"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=JixCyhEGE0A"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=vDNy6EN7bIY"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=R3f0x1IJvhI"
...
- recommended_use: ingest_full
- riesgos: low; audio_proxy_alto|audio_score_sobre_threshold|formato_interview|formato_largo|fuente_argentina_probable|scene_cut_proxy_alto|speaker_count_usable|total_score_alto|visual_score_sobre_threshold|asr_espanol_y_habla_confirmados
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=j4x2GC1Ztro"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=Z-t-GNlxpYc"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=ITovsJg-q5c"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=eqw0QM4A0oA"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=jgp8WZvtkWU"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=h3HtBhArO1Q"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=EhYznjqlcKY"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=YYIVFA000BI"
...
- recommended_use: ingest_partial
- riesgos: low; audio_proxy_alto|audio_score_sobre_threshold|formato_interview|formato_largo|fuente_argentina_probable|scene_cut_proxy_alto|speaker_count_usable|total_score_alto|visual_score_sobre_threshold|asr_espanol_y_habla_confirmados
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=WMk6afYRfKM"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=PRQEkiIWps0"
...
- recommended_use: ingest_full
- riesgos: low; audio_proxy_alto|audio_score_sobre_threshold|formato_interview|formato_largo|fuente_argentina_probable|scene_cut_proxy_alto|speaker_count_usable|total_score_alto|visual_score_sobre_threshold|asr_espanol_y_habla_confirmados
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=sjnH4bTak9s"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=q94HfK07DjI"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=EuSM3LscaWI"
...
- comando tentativo: python data_pipeline/descargar_procesar.py "https://www.youtube.com/watch?v=IGYG0Kn0wxo"
