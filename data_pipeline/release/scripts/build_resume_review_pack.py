...
DISCOVERY = ROOT / "data_pipeline/discovery" / "outputs"
...
def source_summary() -> tuple[list[dict[str, object]], list[str]]:
    ...
    for sid, source in sources.items():
        ...
        commands.append(f"python data_pipeline/release/scripts/reconstruct_existing_clips.py --source {sid} --resume --upload --checkpoint-every 25")
