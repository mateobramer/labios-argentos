...
def selected_rows(args: argparse.Namespace) -> tuple[str, list[dict[str, str]]]:
    if args.new_discovery:
        ...
        if args.retry_blocked or not args.retry_completed:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--retry-blocked", action="store_true", help="Reintentar solo fuentes bloqueadas o que requieren descarga manual.")
