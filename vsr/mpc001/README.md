# vsr/mpc001/ — base multilingüe mpc001 (notas y scripts)

Trabajo sobre la base **CMU-MOSEAS ES multilingüe (mpc001)**: el clon del repo externo
(`vsr/mpc001/repo/`) y las corridas (`runs/`) **no se versionan** (.gitignore);
...
| `scripts/fase0_llm_correct.py` | corrección LLM 1-best (fase 0) — evidencia de [exp. 04 §A-D](../../docs/experiments/04_qwen_corrector.md) |

Resultados asociados: zero-shot mpc001 en [exp. 02](../../docs/experiments/02_zeroshot.md),
remap a espnet1 en [exp. 06](../../docs/experiments/06_demo_y_remap.md).
