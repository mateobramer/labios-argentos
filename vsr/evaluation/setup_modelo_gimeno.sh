...
#
# Uso (desde la raíz del repo):  bash vsr/evaluation/setup_modelo_gimeno.sh
set -e
...
# Gotchas resueltos (ver vsr/evaluation/README.md para el detalle):
...
(antes hay que generar los ROIs y exportarlos: ver vsr/evaluation/README.md)
EOF
