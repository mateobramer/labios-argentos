...
hay que generar `vsr/evaluation/outputs/batch_vsr/rois_lower_face_resized96/`.
...
```text
vsr/evaluation/outputs/batch_vsr/experiments/E0_baseline_original/experiment_config.json
vsr/evaluation/outputs/batch_vsr/experiments/E1_visual_cleaned/experiment_config.json
vsr/evaluation/outputs/batch_vsr/experiments/E2_transcript_cleaned_stronger/experiment_config.json
vsr/evaluation/outputs/batch_vsr/experiments/E3_preprocessing_variant/experiment_config.json
vsr/evaluation/outputs/batch_vsr/experiments/E4_all_combined/experiment_config.json
```

## Decisiones

- Test principal: siempre `vsr/evaluation/outputs/visual_cleaning/manifests/original_test.csv`.
