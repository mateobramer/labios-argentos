...
- Train: `vsr/splits/train.csv` completo.
- Val: `vsr/splits/val.csv` completo.
- Directorio compatible VM: `vsr/evaluation/outputs/visual_cleaning/splits_original/`.
- Test principal: `vsr/splits/test.csv` completo.
...
- Train: `vsr/evaluation/outputs/visual_cleaning/splits_visual_cleaned/train.csv`.
- Val: `vsr/evaluation/outputs/visual_cleaning/splits_visual_cleaned/val.csv`.
- Test principal:
  `vsr/evaluation/outputs/visual_cleaning/manifests/visual_cleaned_test_original.csv`.
