...
Los CSV de resultados deben vivir bajo `vsr/evaluation/outputs/visual_cleaning/`.
...
```text
vsr/evaluation/outputs/visual_cleaning/llm_corrector/baseline_original_llm_corrected.csv
vsr/evaluation/outputs/visual_cleaning/llm_corrector/visual_cleaned_llm_corrected.csv
```
