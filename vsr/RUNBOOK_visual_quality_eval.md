...
El parche local `vsr/evaluation/gimeno_patches/aplicar_parches.py` registra `Rioplatense`
...
python -m cleaning.visual_quality.src.export_visual_quality_vsr_scenario \
  ...
  --output-base vsr/evaluation/data/visual_quality_vsr_eval \
...
```text
vsr/evaluation/data/visual_quality_vsr_eval/Rioplatense/ROIs/<spk>/<sampleID>.npz
vsr/evaluation/data/visual_quality_vsr_eval/Rioplatense/transcriptions/<spk>/<sampleID>.txt
vsr/evaluation/data/visual_quality_vsr_eval/Rioplatense/splits/visual-quality-sample/testRioplatense.csv
...
```bash
rsync -av vsr/evaluation/data/visual_quality_vsr_eval/Rioplatense/ \
  <vm>:~/data/Rioplatense/
```

No versionar `vsr/evaluation/data/visual_quality_vsr_eval/`: contiene copias de ROIs `.npz`
