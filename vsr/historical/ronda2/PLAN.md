# vsr/historical/ronda2 — ablación de datos (ft03 / ft04)
...
- Los splits son **speaker-independent y hardcodeados por fuente** (`vsr/src/armar_splits.py`).
...
2. **Re-armar splits:** `python -m vsr.src.armar_splits` (las nuevas fuentes entran a train).
